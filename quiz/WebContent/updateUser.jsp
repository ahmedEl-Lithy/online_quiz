...
<form action="UserController" method="post">
  ...
  <table>
    <tr>
      <td>name:</td>
      <td><input type="text" name="updatename" required value="<%=name%>"></td>
    </tr>
    <tr>
      <td>username:</td>
      <td><input type="text" name="updateusername" required value="<%=username%>"></td>
    </tr>  
    <tr>
      <td>password:</td>
    ...
    <tr>
      <td>email:</td>
      <td><input type="text" name="updateemail" required value="<%=email%>"></td>
    </tr> 
    <tr>
      <td>user type:</td>
      <td>
